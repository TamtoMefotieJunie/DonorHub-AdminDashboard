  ...
  return (
    <>
      <div className="w-full space-y-3 h-full overflow-y-hidden ">
        <Navbar />
        <p className="text-[#54C2B5] font-bold text-2xl">
          Welcome Back, <span>Junie</span>
        </p>
        <div className="w-full h-[40%] justify-start flex space-x-14 items-center">
          <Cards
            ...
            stats={
              <BarChart
                style={{ width: 60, height: "9%", marginRight: "50" }}
              />
            }
          />
          ...
          <Cards
            ...
            increase="+5.2%"
            stats={<ProgressBar value={0.5} progress="#CF3304" />}
        ...
        <div className="items-center justify-center h-[40%] space-x-3 flex">
          <div className=" h-full w-[60%] bg-white rounded-xl space-y-2 p-4">
            <div className="items-center justify-between flex">
              <p className="text-[#54C2B5] font-bold text-xl">
                Blood Groups running out of stock
              </p>
              <span className="rounded-xl text-white bg-gradient-to-b from-[#54C2B5] to-[#e5e5e5]/90 font-semibold bg-[#54C2B5] p-2 text-center w-[15%]">
                View All
              </span>
            </div>
            <div
            ...
            >
              <div
                className="bg-[#54C2B5]/45 w-full h-full"
                style={{ zIndex: 1 }}
              >
                ...
                <BloodCard
                  group="AB+"
                  type="Simple"
                  component="Red Blood Cell only"
                  status="Less than 10 left"
                />
                <BloodCard
                  group="O-"
                  type="Quadruple"
                  component="RBC / PL / WBC / PLT"
                  status="Less than 5 left"
                />
                <BloodCard
                  group="B-"
                  type="Double"
                  component="Red Blood Cell/WBC"
                  status="Less than 10 left"
                />
                <BloodCard
                  group="O+"
                  type="Tripple"
                  component="RBC / PLT / WBC"
                  status="Less than 10 left"
                />
              </div>
            </div>
